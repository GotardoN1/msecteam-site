...
const heroUrl = assetPath("news-community.jpg");

export default function Story() {
  return <main className="story-shell">
    <nav className="story-nav"><Link href={appPath("/")}><ArrowLeft size={15} /> Voltar ao site</Link><div className="story-brand"><img src={logoUrl} alt="MSEC — Me Sinto em Casa" /><span>MSEC <em>TEAM</em></span></div><a href={appPath("/tryout")}>Fazer parte <ArrowUpRight size={15} /></a></nav>
